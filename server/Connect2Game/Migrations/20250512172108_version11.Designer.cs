...
namespace Connect2Game.Migrations
{
    ...
    [Migration("20250512172108_version11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Connect2Game.Model.Warning", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("ForeignKeyReportId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Connect2Game.Model.Warning", b =>
                {
                    b.HasOne("Connect2Game.Model.Report", "Report")
                        .WithMany()
                        .HasForeignKey("ForeignKeyReportId")
                        .OnDelete(DeleteBehavior.Cascade);
